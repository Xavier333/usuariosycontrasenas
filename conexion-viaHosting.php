...
class conexion{
    ...
    private $servidor ="sql304.epizy.com";
    private $usuario ="epiz_30616016";
    private $pass = "tTBZeqSu7ZrEx";
    private $conexion;#objeto de tipo pdo, de la clase propia de php

    public function __construct(){
        try{
            $this->conexion = new PDO("mysql:host=$this->servidor;dbname=epiz_30616016_usuariosycontrasenas",$this->usuario,$this->pass);
